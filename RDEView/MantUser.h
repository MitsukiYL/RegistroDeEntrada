...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->User_DGV->Margin = System::Windows::Forms::Padding(4);
			...
			this->txt_userID->Margin = System::Windows::Forms::Padding(4);
			...
			this->txt_registrationDate->Margin = System::Windows::Forms::Padding(4);
			...
			this->txt_userType->Margin = System::Windows::Forms::Padding(4);
			...
			this->txt_ParkLotID->Margin = System::Windows::Forms::Padding(4);
			...
			this->VehiclexUser_DGV->Margin = System::Windows::Forms::Padding(4);
