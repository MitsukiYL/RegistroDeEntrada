...
namespace RDEView {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ menúDePeticionesToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->menúDePeticionesToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->perfilDeUsuarioToolStripMenuItem->Size = System::Drawing::Size(182, 22);
			...
			this->menúDeInscripciónToolStripMenuItem->Size = System::Drawing::Size(182, 22);
			...
			// 
			// menúDePeticionesToolStripMenuItem
			// 
			this->menúDePeticionesToolStripMenuItem->Name = L"menúDePeticionesToolStripMenuItem";
			this->menúDePeticionesToolStripMenuItem->Size = System::Drawing::Size(182, 22);
			this->menúDePeticionesToolStripMenuItem->Text = L"Menú de peticiones";
			this->menúDePeticionesToolStripMenuItem->Click += gcnew System::EventHandler(this, &RDEMasterMenu::menúDePeticionesToolStripMenuItem_Click);
			// 
			// registroDeEntradaToolStripMenuItem
			// 
			this->registroDeEntradaToolStripMenuItem->Name = L"registroDeEntradaToolStripMenuItem";
			this->registroDeEntradaToolStripMenuItem->Size = System::Drawing::Size(182, 22);
			...
			this->xdToolStripMenuItem3->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(12) {
				this->usuariosToolStripMenuItem,
					this->vehiculosToolStripMenuItem, this->zonasToolStripMenuItem, this->estacionamientosToolStripMenuItem, this->playasToolStripMenuItem,
					this->tarjetasToolStripMenuItem, this->sensoresToolStripMenuItem, this->puertasToolStripMenuItem, this->motoresToolStripMenuItem,
					this->interfacesToolStripMenuItem, this->administradoresToolStripMenuItem, this->personasToolStripMenuItem
			});
			...
			this->sensoresToolStripMenuItem->Size = System::Drawing::Size(167, 22);
			...
			this->puertasToolStripMenuItem->Size = System::Drawing::Size(167, 22);
			...
			this->motoresToolStripMenuItem->Size = System::Drawing::Size(167, 22);
			...
			this->interfacesToolStripMenuItem->Size = System::Drawing::Size(167, 22);
...
private: System::Void menúDePeticionesToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
...
private: System::Void usuariosToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	MantUser^ mantuserform = gcnew MantUser();
	mantuserform->Show();
}
