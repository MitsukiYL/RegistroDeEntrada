...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(326, 200);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(165, 200);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(13, 200);
			...
			this->Person_DGV->Location = System::Drawing::Point(13, 245);
			...
			// txt_password
			// 
			this->txt_password->Location = System::Drawing::Point(531, 83);
			...
			this->label4->Location = System::Drawing::Point(375, 89);
			...
			// txt_phone
			// 
			this->txt_phone->Location = System::Drawing::Point(531, 43);
			...
			// txt_mail
			// 
			this->txt_mail->Location = System::Drawing::Point(531, 3);
			...
			this->label6->Location = System::Drawing::Point(375, 10);
			...
			// txt_dni
			// 
			this->txt_dni->Location = System::Drawing::Point(95, 84);
			...
			this->label3->Click += gcnew System::EventHandler(this, &MantAdmin::label3_Click);
			// 
			// txt_code
			// 
			this->txt_code->Location = System::Drawing::Point(95, 44);
			...
			// txt_name
			// 
			this->txt_name->Location = System::Drawing::Point(95, 4);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(531, 119);
			...
			this->label7->Location = System::Drawing::Point(375, 125);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(95, 122);
			...
			this->Text = L"Mantenimiento de Administracion";
